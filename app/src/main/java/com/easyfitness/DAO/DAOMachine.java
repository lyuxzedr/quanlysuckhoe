...
public class DAOMachine extends DAOBase {
    ...
    /**
     * @param pName        the Record to add to the base
     * @param pDescription
     * @param pType
     */
...
// Select All Query
    ...
    public void populate() {
        addMachine("Dev", "Developper : blabla ", ExerciseType.STRENGTH, "", true, "");
        addMachine("B", "Developper : blabla ", ExerciseType.STRENGTH, "", false, "");
    }
